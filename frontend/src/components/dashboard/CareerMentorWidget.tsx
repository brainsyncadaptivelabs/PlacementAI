  ...
  return (
    <Card className="bg-primary text-white relative overflow-hidden rounded-[2rem] border-transparent shadow-md">
       <div className="relative z-10 space-y-6">
          ...
          <div className="bg-white/10 border border-transparent rounded-2xl p-4 cursor-pointer hover:bg-white/20 transition-all group" onClick={onOpenChat}>
          ...
          <Button className="w-full bg-white text-primary hover:bg-slate-50 font-black h-12 rounded-xl shadow-md" onClick={onOpenChat}>
             Open AI Chat
          </Button>
       </div>

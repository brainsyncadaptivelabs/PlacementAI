...
const data = [
  { name: "Mon", users: 2400, revenue: 400 },
  { name: "Tue", users: 1398, revenue: 300 },
  { name: "Wed", users: 9800, revenue: 1200 },
  { name: "Thu", users: 3908, revenue: 800 },
  { name: "Fri", users: 4800, revenue: 1000 },
  { name: "Sat", users: 3800, revenue: 900 },
  { name: "Sun", users: 4300, revenue: 1100 },
];

export default function PerfectAdminPortal() {
  return (
    <div className="min-h-screen bg-muted p-8 space-y-8 font-sans">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" className="border-border bg-card shadow-sm font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Active Nodes", value: "14", trend: "+2", icon: Server, color: "text-emerald-600", bg: "bg-emerald-50" },
          { label: "Platform Revenue", value: "₹42.8k", trend: "+12%", icon: TrendingUp, color: "text-blue-600", bg: "bg-blue-50" },
          { label: "API Requests", value: "1.2M", trend: "-2%", icon: Database, color: "text-purple-600", bg: "bg-purple-50" },
          { label: "Security Alerts", value: "0", trend: "Stable", icon: ShieldAlert, color: "text-muted-foreground", bg: "bg-muted" },
        ].map((m, i) => (

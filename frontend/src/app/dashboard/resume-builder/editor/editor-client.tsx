              ...
              <div className="flex flex-wrap gap-1.5 bg-slate-200/50 p-1.5 rounded-xl">
                {(["personal", "summary", "skills", "experience", "projects", "education", "certifications", "achievements"] as const).map(section => (
                  <button
                    ...
                    className={`flex-auto py-2 px-3 text-[10px] md:text-xs font-bold uppercase tracking-wider rounded-lg transition-all ${
                      activeSection === section 
                        ? "bg-card text-foreground shadow-sm ring-1 ring-border/50" 
                        : "text-muted-foreground hover:text-foreground hover:bg-slate-300/30"
                    }`}
                  >

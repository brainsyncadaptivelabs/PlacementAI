...
import { Scale, FileText, CheckCircle2, AlertCircle, TrendingUp, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col gap-1 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">Upload or select two resumes to compare their effectiveness and see which one performs better for your target role.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
        ...
        {/* Resume 1 */}
        <Card className="border-2 border-dashed border-border bg-card shadow-none hover:border-primary/40 transition-colors">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="border-none shadow-sm overflow-hidden bg-card">
                 <div className="p-6 border-b border-border flex items-center justify-between">
                    <div>
                       <h4 className="font-bold text-foreground">Resume_A_v1.pdf</h4>
                       <p className="text-xs text-muted-foreground/70 font-medium uppercase tracking-wider">Candidate A</p>
                    </div>
                    <Badge className="bg-muted text-muted-foreground font-bold border-none">62%</Badge>
                 </div>
              ...
              {/* Resume B Result */}
              <Card className="border-2 border-primary/20 shadow-xl overflow-hidden bg-card relative">
           ...
           <Card className="border-none shadow-sm bg-slate-900 text-white p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                 ...
                 <div className="space-y-2 flex-1 text-center md:text-left">
                    ...
                    <p className="text-muted-foreground/70 text-sm">Resume B follows professional standards more closely and contains 85% of the required keywords for a Backend Engineer role compared to 55% in Resume A.</p>
                 </div>

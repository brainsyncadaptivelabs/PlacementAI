  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-muted-foreground font-medium italic">Scanning your expertise and identifying growth gaps...</p>
      </div>
    );
  }
    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-muted-foreground">Understand your position in the current job market and identify growth opportunities.</p>
        </div>
        <Card className="border-none shadow-sm bg-card px-6 py-3 flex items-center gap-4">
           <div className="text-right">
              <p className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest leading-none mb-1">AI Assessed Level</p>
              <p className="text-sm font-black text-foreground">{result?.careerLevel || "Determining..."}</p>
           </div>
         ...
         <Card className="lg:col-span-2 border-none shadow-sm bg-card overflow-hidden">
            ...
            <CardContent className="p-8 grid grid-cols-1 md:grid-cols-2 gap-12">
               <div className="space-y-6">
                  <h3 className="text-xs font-bold text-muted-foreground/70 uppercase tracking-widest">Strong Skills</h3>
               ...
               <div className="space-y-6">
                  <h3 className="text-xs font-bold text-muted-foreground/70 uppercase tracking-widest">Missing / Gap Skills</h3>
                  <div className="flex flex-wrap gap-2">
         ...
         <div className="space-y-6">
               ...
               <div className="relative z-10 space-y-4">
                  ...
                  <div className="space-y-2">
                    {result?.recommendedSkills.slice(0, 3).map(skill => (
                      <div key={skill} className="flex items-center gap-2 text-sm text-muted-foreground/50">
            ...
            <Card className="border-none shadow-sm bg-card p-6">
               <div className="space-y-4">
                  <h3 className="text-sm font-bold text-foreground uppercase tracking-widest">Next Step</h3>
                  <p className="text-xs text-muted-foreground">Ready to test your skills? Practice with our AI interviewer.</p>

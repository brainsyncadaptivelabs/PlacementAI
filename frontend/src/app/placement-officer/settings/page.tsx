...
export default function PlacementOfficerSettingsPage() {
    ...
    try {
      ...
      element.innerHTML = `
        ...
        <div style="margin-bottom: 40px;">
          <h2 style="font-size: 16px; font-weight: 700; color: #4f46e5; text-transform: uppercase; letter-spacing: 0.5px; margin: 0 0 15px 0; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">2. Account Preferences</h2>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px 30px;">
            <div>
          ...
          <CardContent className="flex flex-col">
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-muted-foreground">Receive weekly candidate matches and application updates.</span>
              </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-muted-foreground">Get real-time browser alerts when a candidate messages you or applies.</span>
              </div>

...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-card">
      {/* SECTION 1 — NAVBAR */}
      <header className="px-4 md:px-8 h-20 flex items-center border-b border-border sticky top-0 bg-card/90 backdrop-blur-md z-50">
        <Link className="flex items-center justify-center gap-2" href="/">
          <PlacementAILogo size={44} />
        ...
        <div className="ml-auto md:hidden">
          <Link href="/auth">
            <Button className="font-bold h-11 px-5 rounded-xl text-xs">Get Started</Button>
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1">
        {/* SECTION 2 — HERO */}
        <section className="w-full py-10 md:py-24 lg:py-32 px-4 md:px-8 overflow-hidden relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 rounded-full blur-3xl -z-10" />
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
              <div className="flex flex-col justify-center space-y-6 md:space-y-8 lg:w-1/2">
                <div className="space-y-4 md:space-y-6">
                  ...
                  <h1 className="text-[36px] sm:text-5xl xl:text-6xl font-black tracking-tight font-heading text-foreground leading-tight">
                    Know exactly what stands between you and your next offer.
                  </h1>
                  <p className="max-w-[90%] md:max-w-[600px] text-muted-foreground md:text-lg font-medium leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/auth">
                    <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 px-6 h-[52px] sm:h-auto sm:py-7 text-base sm:text-lg font-bold shadow-xl shadow-primary/30 group rounded-[16px]">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-5xl">
            <div className="flex flex-col lg:flex-row gap-10 md:gap-12 items-center">
              <div className="lg:w-1/2 space-y-4">
                <h2 className="text-[32px] md:text-4xl font-black font-heading text-foreground leading-tight">
              ...
              <div className="lg:w-1/2 w-full space-y-[14px] md:space-y-6">
                <div className="flex gap-3 md:gap-4 items-start p-4 md:p-5 bg-card rounded-2xl border border-border shadow-sm">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-red-100 flex items-center justify-center text-red-600 font-bold text-sm shrink-0">!</div>
                  <div>
        ...
        <section id="product" className="w-full py-16 md:py-24 bg-card">
          <div className="container mx-auto px-4 md:px-8">
            <div className="text-center max-w-3xl mx-auto mb-14 md:mb-20 space-y-4">
              ...
              <h3 className="text-[38px] md:text-4xl font-black font-heading text-foreground leading-tight">One unified placement intelligence copilot</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px] md:gap-8 max-w-6xl mx-auto">
              <PillarCard
        ...
        <section id="how-it-works" className="w-full py-16 md:py-24 border-t border-b border-border bg-muted/10">
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px] md:gap-12 max-w-6xl mx-auto relative">
              <StepItem
                number="01"
            ...
            <div className="flex flex-col lg:flex-row gap-10 md:gap-16 items-center">
              <div className="lg:w-1/2 space-y-6 md:space-y-8">
                <div className="space-y-4">
                  ...
                  <h3 className="text-[38px] md:text-4xl font-black font-heading text-foreground leading-tight">Your placement preparation should be measurable.</h3>
                  <p className="text-muted-foreground font-medium leading-relaxed">
              ...
              <div className="lg:w-1/2 w-full">
                <Card className="p-5 md:p-6 border border-border shadow-xl bg-card">
                  <CardContent className="space-y-6 p-0">
                    <div className="font-heading font-black text-xs md:text-sm text-foreground border-b border-border pb-3 uppercase">Placement Readiness Metrics (Sample Profile)</div>
                    <div className="space-y-4">
        ...
        {/* SECTION 7 — FINAL CTA */}
        <section className="w-full py-16 md:py-24 px-4 bg-muted/30 border-t border-border">
          <div className="max-w-4xl mx-auto rounded-3xl border border-border bg-card shadow-2xl overflow-hidden relative">
            ...
            <div className="p-6 md:p-16 text-center space-y-8 relative z-10">
              <h2 className="text-[32px] md:text-4xl font-black font-heading leading-tight text-foreground select-text">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
                <Link href="/auth" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full bg-primary hover:bg-primary/90 text-white font-bold px-6 h-[52px] sm:h-auto sm:py-6 text-base sm:text-lg shadow-xl rounded-[16px]">
                    Analyze My Placement Readiness
                  </Button>
                </Link>
                <Link href="#product" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 h-[52px] sm:h-auto sm:py-6 text-base sm:text-lg shadow-xl rounded-[16px]">
                    Explore PlacementAI
                  </Button>
                </Link>
              </div>
...
function PillarCard({ icon, title, desc, labels }: { icon: React.ReactNode, title: string, desc: string, labels: string[] }) {
  return (
    <Card className="border border-border shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-card p-5 md:p-8">

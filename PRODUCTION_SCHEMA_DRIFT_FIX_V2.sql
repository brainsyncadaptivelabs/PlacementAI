-- ===========================================================================
-- PRODUCTION DATABASE SCHEMA DRIFT FIX MIGRATION (V2)
-- ===========================================================================
-- Safe, non-destructive, and idempotent PostgreSQL script to resolve 
-- "column contains null values" and "column does not exist" constraints
-- during Hibernate schema updates on existing tables.
-- ===========================================================================

-- 1. Safely add columns as nullable first (prevents startup and alter errors)
...
-- 2. Populate default values for existing rows with NULL values
...
-- 3. Enforce default constraints and NOT NULL verification safely

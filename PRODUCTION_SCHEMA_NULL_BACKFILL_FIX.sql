-- ===========================================================================
-- PRODUCTION DATABASE SCHEMA DRIFT & NULL BACKFILL FIX
-- ===========================================================================
-- Safe, non-destructive, and idempotent PostgreSQL script to resolve 
-- column constraint conflicts by ensuring columns exist, backfilling NULL
-- values with defaults, and applying NOT NULL constraints to existing columns.
-- ===========================================================================

-- 1. Ensure columns exist (nullable first to prevent execution halts)

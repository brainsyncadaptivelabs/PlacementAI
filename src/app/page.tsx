...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Header */}
      <header className="px-4 lg:px-8 h-20 flex items-center border-b border-slate-50 sticky top-0 bg-white/90 backdrop-blur-md z-50">
        ...
        <nav className="ml-auto hidden md:flex gap-8 items-center">
          <Link className="text-sm font-bold text-slate-600 hover:text-primary transition-colors uppercase tracking-widest" href="#features">Features</Link>
          <Link className="text-sm font-bold text-slate-600 hover:text-primary transition-colors uppercase tracking-widest" href="#how-it-works">How It Works</Link>
          <Link className="text-sm font-bold text-slate-600 hover:text-primary transition-colors uppercase tracking-widest" href="#pricing">Pricing</Link>
          <Link className="text-sm font-bold text-slate-600 hover:text-primary transition-colors uppercase tracking-widest" href="#about">About Us</Link>
          <div className="h-6 w-px bg-slate-200 mx-2" />
          <Link href="/auth">
            <Button variant="ghost" className="font-bold text-slate-900">Login</Button>
          </Link>
          <Link href="/auth">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="flex flex-col justify-center space-y-10 lg:w-1/2">
                <div className="space-y-6">
                  ...
                  <h1 className="text-5xl font-black tracking-tight sm:text-6xl xl:text-7xl/none font-heading text-slate-900 leading-tight">
                    Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">AI-Powered</span> <br />
                    Career Co-Pilot
                  </h1>
                  <p className="max-w-[600px] text-slate-500 md:text-xl/relaxed lg:text-lg/relaxed xl:text-xl/relaxed font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <Button variant="outline" size="lg" className="px-10 py-8 text-xl font-bold border-2 hover:bg-slate-50">
                    See How It Works
                  </Button>
                </div>
                <div className="flex items-center gap-8 pt-4">
                   ...
                   <p className="text-sm font-bold text-slate-400 uppercase tracking-wider">Trusted by 2,000+ Students</p>
                </div>
              </div>
              <div className="lg:w-1/2 w-full relative">
                <div className="relative aspect-[4/3] rounded-3xl bg-slate-900/5 overflow-hidden border border-slate-200 shadow-2xl p-4 group">
                   <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                   <div className="h-full w-full bg-white rounded-2xl border border-slate-100 shadow-inner flex items-center justify-center relative overflow-hidden">
                      <div className="absolute top-4 left-4 right-4 h-12 bg-slate-50 rounded-lg border border-slate-100 flex items-center px-4 gap-2">
                      ...
                      <div className="space-y-6 w-full max-w-sm px-8">
                         ...
                         <div className="h-32 bg-slate-50 rounded-xl border border-slate-100 flex flex-col items-center justify-center text-slate-300 font-bold text-xs uppercase tracking-widest">
        ...
        {/* Features Section */}
        <section id="features" className="w-full py-24 md:py-32 bg-slate-50/50">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
               <h2 className="text-xs font-black text-primary uppercase tracking-[0.3em]">Core Features</h2>
               <h3 className="text-4xl font-bold font-heading text-slate-900">Everything you need in one platform</h3>
               <p className="text-slate-500 font-medium">From initial resume drafting to final interview practice, we cover every step of your placement journey.</p>
            </div>
        ...
        <section id="how-it-works" className="w-full py-24 md:py-32">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
               ...
               <h3 className="text-4xl font-bold font-heading text-slate-900">4 Steps to Your Dream Job</h3>
            </div>
            
            <div className="relative">
               {/* Desktop Connector Line */}
               <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-slate-100 -translate-y-1/2 hidden lg:block -z-10" />
        ...
        <section id="pricing" className="w-full py-24 md:py-32 bg-slate-900 text-white">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
               ...
               <p className="text-slate-400 font-medium">Simple, transparent pricing to help you grow your career.</p>
            </div>
        ...
        {/* About Us Section */}
        <section id="about" className="w-full py-24 md:py-32 border-b border-slate-100">
          <div className="container mx-auto px-4 lg:px-8">
           ...
           <Card className="max-w-5xl mx-auto border-none shadow-2xl bg-gradient-to-r from-primary to-secondary text-white overflow-hidden relative">
              ...
              <CardContent className="p-12 md:p-20 text-center space-y-10 relative z-10">
                 ...
                 <div className="flex flex-col sm:flex-row justify-center gap-6">
                    <Link href="/auth">
                       <Button size="lg" className="bg-white text-primary hover:bg-slate-50 font-black px-12 py-8 text-xl shadow-xl">Get Started Now</Button>
                    </Link>
                    <Button variant="outline" size="lg" className="border-2 border-white/40 text-white hover:bg-white/10 font-black px-12 py-8 text-xl backdrop-blur-sm">View Demo</Button>
                 </div>
              </CardContent>
           </Card>
        </section>
      ...
      <footer className="bg-slate-50 py-20 px-4 lg:px-8 border-t border-slate-200">
        <div className="container mx-auto">
           <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
              <div className="col-span-1 md:col-span-1 space-y-6">
                 ...
                 <p className="text-sm text-slate-500 font-medium leading-relaxed">The only AI-powered companion designed specifically to help students bridge the skill gap and land their dream offers.</p>
                 <div className="flex gap-4">
                    {[1,2,3].map(i => <div key={i} className="w-8 h-8 rounded-full bg-slate-200" />)}
                 </div>
              </div>
              <div className="space-y-6">
                 <h4 className="font-black text-xs uppercase tracking-[0.2em] text-slate-900">Product</h4>
                 <ul className="space-y-4">
                    {["ATS Analysis", "AI Mock Interviews", "Personalized Roadmaps", "Career Chatbot"].map(i => (
                       <li key={i}><Link href="#" className="text-sm text-slate-500 hover:text-primary transition-colors font-semibold">{i}</Link></li>
                    ))}
                 </ul>
              </div>
              <div className="space-y-6">
                 <h4 className="font-black text-xs uppercase tracking-[0.2em] text-slate-900">Company</h4>
                 <ul className="space-y-4">
              ...
              <div className="space-y-6">
                 <h4 className="font-black text-xs uppercase tracking-[0.2em] text-slate-900">Legal</h4>
                 <ul className="space-y-4">
           ...
           <div className="mt-20 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">© 2026 AI Placement Copilot. Built with ❤️ for students.</p>
...
function FeatureCard({ icon, title, desc, color }: { icon: any, title: string, desc: string, color: string }) {
   ...
   return (
      <Card className="border-none shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 bg-white group p-4 overflow-hidden relative">
         <CardContent className="pt-8 pb-8 space-y-6 relative z-10">
            ...
            <div className="space-y-3">
               <h3 className="font-black text-xl font-heading text-slate-900">{title}</h3>
         ...
         <div className="absolute -right-8 -bottom-8 w-32 h-32 bg-slate-50 rounded-full group-hover:scale-[3] transition-transform duration-700 -z-0" />
      </Card>
   );
}
   ...
   return (
      <div className="space-y-6 text-center lg:text-left group relative">
         <div className="flex flex-col lg:flex-row items-center gap-4">
            <div className="w-14 h-14 rounded-full bg-white border-2 border-slate-100 shadow-sm flex items-center justify-center font-black text-slate-900 group-hover:border-primary group-hover:text-primary transition-all relative z-10">
               {icon}
            </div>
...
function PricingCard({ title, price, desc, features, cta, variant, highlight }: { title: string, price: string, desc: string, features: string[], cta: string, variant: string, highlight?: boolean }) {
   return (
      <Card className={`p-8 border-none shadow-xl flex flex-col space-y-8 relative overflow-hidden ${highlight ? 'bg-primary ring-4 ring-primary/20 scale-105 z-10' : 'bg-slate-800'}`}>
         ...
         <Button className={`w-full py-8 text-lg font-black shadow-lg ${highlight ? 'bg-white text-primary hover:bg-slate-50' : 'bg-primary hover:bg-primary/90'}`}>
            {cta}
         </Button>
      </Card>
   );
